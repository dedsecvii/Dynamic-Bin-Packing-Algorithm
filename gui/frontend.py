...
class BinPackingGUI:
    ...
    def update_metrics(self, bins: List[Bin], runtime: float):
        ...
        self.Efficiency_label.config(text=f"Efficiency: {round(avg_total_utilization*departed_items_percentage(all_bins) / ((total_bins / total_items)*(10000*runtime/(total_items*math.log(total_items,2))+0.00001)), 2)}")
